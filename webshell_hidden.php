...
function test($rawstr) {
    $str឴឴឴឴឴឴឵឵឵ = str_pad($rawstr, strlen($rawstr)+strlen($rawstr)%4, "0", STR_PAD_LEFT);
    $result឴឴឴឴឴឴឴឵឵ = array();
    $index឴឴឴឴឴឴឵឵឵឵឵ = -4;
    while (abs($index឴឴឴឴឴឴឵឵឵឵឵) <= strlen($str឴឴឴឴឴឴឵឵឵)) {
        array_push($result឴឴឴឴឴឴឴឵឵, base_convert(substr($str឴឴឴឴឴឴឵឵឵, $index឴឴឴឴឴឴឵឵឵឵឵, 4), 2, 16));
        $index឴឴឴឴឴឴឵឵឵឵឵ -= 4;
    }
    return implode("", array_reverse($result឴឴឴឴឴឴឴឵឵));
}
    ...
    function getArrayValue($test_str) {
        ...
        if (isset($match_test_1[0])) {
            ...
            for($i = 0; $i < strlen($content឴឴឴឴឴឴឵឵឵឵឵឵឵឵឵឵឵឵឵឵); $i++) {
                ...
                if($content឴឴឴឴឴឴឵឵឵឵឵឵឵឵឵឵឵឵឵឵[$i] == $content឴឴឴឴឴឴឵឵឵឵឵឵឵឵឵឵឵឵឵឵[1]) {
